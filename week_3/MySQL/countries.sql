...
select countries.name, cities.country_code from countries
...
select name, population, country_code from cities
...
-- cities8. What query would you run to summarize the number of countries in each region? The query should display the name of the region and the number of countries. Also, the query should arrange the result by the number of countries in descending order. (2)